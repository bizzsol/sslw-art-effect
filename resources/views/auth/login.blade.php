                    ...
                    <div class="sign-in-detail text-white">
                        <div>
                            <div class="item login-slider">
                                <img src="{{ asset(session()->get('system-information')['secondary_logo']) }}"
                                     class="img-fluid mb-2 radius-10 bg-white p-2" alt="logo">
                            ...
                            <div class="d-inline-block w-100">
                                <div class="row">
                                    <div class="col-md-6 pt-2">
                                        <a class="text-primary" href="{{ route('password.request') }}"><strong>Forgot
                                                                                                               Password
                                                                                                               ?</strong></a>
                                    </div>
