                        ...
                        <div class="sign-in-from">
                            ...
                            @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="otp" type="text" maxlength="6" class="form-control mb-0 @error('otp') is-invalid @enderror" id="otp" value="{{ old('otp') }}" required autocomplete="off" autofocus>
                                    @error('email')
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-6 pt-2">
                                        <a class="text-primary" href="{{ route('login') }}"><strong>Go Back</strong></a>
                                    </div>
