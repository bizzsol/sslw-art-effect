        ...
        <div class="page-content">
            <div class="">
                <div class="panel panel-info">
                    <form  method="post" action="{{ route('pms.sbu.update', $unit->hr_unit_id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                          ...
                          <div class="form-group row">
                            <div class="col-md-3">
                              ...
                              <select name="company_id" id="company_id" class="form-control">
                                  ...
                                  <option value="{{ $company->id }}" {{ $unit->company_id == $company->id ? 'selected' : '' }}>[{{ $company->code }}] {{ $company->name }}</option>
                                  @endforeach
                                  @endif
                              </select>
                            </div>
                            <div class="col-md-2">
                              ...
                              <input type="text" class="form-control" name="hr_unit_code" value="{{ old('hr_unit_code', $unit->hr_unit_code) }}" id="hr_unit_code">
                            </div>
                            <div class="col-md-2">
                              <label for="hr_unit_short_name"><strong>SBU Short Name <span class="text-danger">&nbsp;*</span> </strong></label>
                              <input type="text" class="form-control" name="hr_unit_short_name" value="{{ old('hr_unit_short_name', $unit->hr_unit_short_name) }}" id="hr_unit_short_name">
                            </div>
                            <div class="col-md-5">
                              <label for="hr_unit_name"><strong>SBU Name <span class="text-danger">&nbsp;*</span> </strong></label>
                              <input type="text" class="form-control" name="hr_unit_name" value="{{ old('hr_unit_name', $unit->hr_unit_name) }}" id="hr_unit_name">
                            </div>
