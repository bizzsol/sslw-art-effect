                ...
                <div class="panel panel-info">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <p class="mb-1 font-weight-bold"><label for="name"><strong>{{ __('Quatily Issues') }}<span class="text-danger">&nbsp;*</span></strong></label> {!! $errors->has('name')? '<span class="text-danger text-capitalize">'. $errors->first('name').'</span>':'' !!}</p>
