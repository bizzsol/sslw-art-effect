            ...
            <div class="page-content">
                <div class="">
                    <div class="panel panel-info">
                        <form method="post" action="{{ route('pms.sections.store') }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" class="form-control" name="hr_section_code"
                                               value="{{ old('hr_section_code') }}" id="hr_section_code" required>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="hr_section_name"
                                               value="{{ old('hr_section_name') }}" id="hr_section_name" required>
                                    </div>
                                </div>
                                <button type="submit" class="mt-2 btn btn-success rounded">
                                    <i class="la la-check"></i>&nbsp;{{ __('Create Section') }}
                                </button>
                            </div>
                        </form>
                    </div>
