<table class="table table-striped table-bordered miw-500" cellspacing="0" width="100%" id="dataTable">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                {{isset($values->relRequisitionDelivery->relRequisition->relUsersList->employee->unit->hr_unit_short_name)?$values->relRequisitionDelivery->relRequisition->relUsersList->employee->unit->hr_unit_short_name:''}}
            </td>
            <td>
                {{isset($values->relRequisitionDelivery->relRequisition->relUsersList->employee->department->hr_department_name)?$values->relRequisitionDelivery->relRequisition->relUsersList->employee->department->hr_department_name:''}}
            </td>
            ...
            <td>{{ isset($values->product->name)?$values->product->name:'' }}</td>
