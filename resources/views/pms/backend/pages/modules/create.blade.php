        ...
        <div class="page-content">
            <div class="">
                <div class="panel panel-info">
                    <form  method="post" action="{{ route('pms.modules.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="panel-body">
                          <div class="form-group row">
                            ...
                            <div class="col-md-3">
                              ...
                              <input type="text" class="form-control" name="icon" value="{{ old('icon') }}" id="icon">
                            </div>
                          </div>
                          <div class="form-group row">
                            <div class="col-md-4">
                              <label for="dashboard"><strong>Dashboard <span class="text-danger">&nbsp;*</span></strong></label>
                              <input type="text" class="form-control" name="dashboard" value="{{ old('dashboard') }}" id="dashboard">
                            </div>
                            <div class="col-md-8">
                          ...
                          <button type="submit" class="mt-2 btn btn-success rounded">
                              <i class="la la-check"></i>&nbsp;{{ __('Create Module') }}
                          </button>
                        </div>
                    </form>
                </div>
