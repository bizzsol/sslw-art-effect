                        ...
                        <div class="panel-body">
                            {!! Form::open(array('route' => ['pms.acl.menu.update',$data->id],'method'=>'PUT','class'=>'','files'=>true)) !!}
                                    ...
                                    <div class="form-group row {{ $errors->has('module') ? 'has-error' : '' }}">
                                        <label for="module" class="col-md-2 control-label text-right">Module&nbsp;<span class="text-danger">&nbsp;*</span></label>
                                        <div class="col-md-8">
                                            <div class="input-group input-group-md mb-3 d-">
                                                <select class="form-control" name="module" id="module">
                                                    @foreach(menuModules() as $module)
                                                        <option value="{{$module}}" {{ $data->module == $module ? 'selected' : '' }}>{{ucwords(implode(' ', explode('-', $module)))}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row   {{ $errors->has('name') ? 'has-error' : '' }}">
                                        {{Form::label('name', ' Name', array('class' => 'col-md-2 control-label text-right'))}}<strong><span class="text-danger">&nbsp;*</span></strong>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group row  {{ $errors->has('url') ? 'has-error' : '' }}">
                                        ...
                                        {{Form::label('url', 'URL', array('class' => 'col-md-2 control-label text-right'))}} <strong><span class="text-danger">&nbsp;*</span></strong>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        {{Form::label('serial_num', 'Others', array('class' => 'col-md-2 control-label text-right'))}}<strong><span class="text-danger">&nbsp;*</span></strong>
                                        <div class="col-md-2">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            {!! Form::select('slug[]', $permissions,json_decode($data->slug), array('id'=>'slug','class' => 'form-control kt-select2','multiple'=>true,'required'=>false)) !!}
