                        ...
                        <div class="panel-body">
                            {!! Form::open(array('route' => 'pms.acl.menu.store','method'=>'POST','class'=>'','files'=>true)) !!}
                                            ...
                                            <div class="input-group input-group-md mb-3 d-">
                                                <select class="form-control" name="module" id="module">
                                                    @foreach(menuModules() as $module)
                                                        <option value="{{$module}}">{{ucwords(implode(' ', explode('-', $module)))}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            {!! Form::select('slug[]', $permissions,[], array('id'=>'slug','class' => 'form-control kt-select2','multiple'=>true,'required'=>false)) !!}
