                        ...
                        <div class="panel-body">
                            ...
                            {!! Form::open(array('route' => 'pms.acl.sub-menu.store','method'=>'POST','class'=>'kt-form kt-form--label-right','files'=>true)) !!}
                                ...
                                <div class="form-group row   {{ $errors->has('name') ? 'has-error' : '' }}">
                                    {{Form::label('name', ' Sub Menu', array('class' => 'col-md-2 control-label text-right'))}} <strong><span class="text-danger">&nbsp;*</span></strong>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        {!! Form::select('slug[]', $permissions,[], array('class' => 'form-control','multiple'=>true,'required'=>false)) !!}
                                    ...
                                    <table class="table table-striped table-hover table-bordered center_table" id="my_table">
                                        ...
                                        @forelse($allData as $data)
                                            <tr>
                                                ...
                                                <td>{{ucwords(implode(' ', explode('-', $menu->module)))}}</td>
                                                <td>{{$menu->name}}</td>
