                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group input-group-md mb-3 d-">
                                            <select name="payable_account_id" id="payable_account_id" class="form-control rounded">
                                                {!! chartOfAccountsOptions([], (isset($supplier->payableAccount->id) ? $supplier->payableAccount->id : $accountDefaultSettings['supplier_payable_account']), 0, $getAllGroupAndLedgers) !!}
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group input-group-md mb-3 d-">
                                            <select name="advance_account_id" id="advance_account_id" class="form-control rounded">
                                                {!! chartOfAccountsOptions([], (isset($supplier->advanceAccount->id) ? $supplier->advanceAccount->id : $accountDefaultSettings['supplier_advance_account']), 0, $getAllGroupAndLedgers) !!}
                                            </select>
                                        </div>
                                    </div>
                                </div>
