											...
											<table class="table table-bordered">
												...
												<tbody>
													...
													<tr id="removeApprovedRow{{$item->id}}">
														...
														<td class="text-right">{{systemDoubleValue(($item->qty-$item->received_qty)*$item->unit_amount,2)}}</td>	
													</tr>
													@endforeach
													<tr>
													...
													<tr>
														...
														<td>{{systemDoubleValue($vatAmount,4)}}</td>
													</tr>
													<tr>
														<td colspan="6" class="text-right"><strong>Total Amount</strong></td>
														<td><strong>{{systemDoubleValue(($sumOfPrice-$discountAmount)+$vatAmount,4)}}</strong></td>
													</tr>
													@else
													<tr>
