									...
									<div class="panel panel-body">
										<div class="row mb-3">
											<div class="col-md-6 text-left">
												<h1><strong style="font-size: 30px !important;">Return Items</strong></h1>
											</div>
												...
												<tbody>
													<tr>
														...
														<td style="width: 50% !important;text-align: right !important">
															{!! printBarcode($code, 'float: right', '8px') !!}
														</td>
													</tr>
													<tr>
											...
											<table class="table table-bordered">
												...
												<tbody>
													...
													<tr>
														...
														<td class="text-right">{{isset($sumOfItemQty)?systemDoubleValue($sumOfItemQty,0):0}}</td>
														...
														<td class="text-right">{{isset($returned)?systemDoubleValue($sumOfSubtotal,4):0}}</td>
													</tr>
													{{-- <tr>
