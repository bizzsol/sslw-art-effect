        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="warehouseForm">
                    <div class="form-row">
                        <div class="col-md-6">
                            <p class="mb-1 font-weight-bold"><label for="name"><strong>{{ __('Name') }}<span class="text-danger">&nbsp;*</span></strong></label> <span class="text-danger"></span></p>
                        ...
                        <div class="col-md-6">
                            <p class="mb-1 font-weight-bold"><label for="email"><strong>{{ __('Email') }}<span class="text-danger">&nbsp;*</span></strong></label> <span class="text-danger"></span></p>
                        ...
                        <div class="col-md-6">
                            <p class="mb-1 font-weight-bold"><label for="phone"><strong>{{ __('Phone') }}<span class="text-danger">&nbsp;*</span></strong></label> <span class="text-danger"></span></p>
                            <div class="input-group input-group-md mb-3">
                        ...
                        <div class="col-md-6">
                            <p class="mb-1 font-weight-bold"><label for="code"><strong>{{ __('Code') }}<span class="text-danger">&nbsp;*</span></strong></label> <span class="text-danger"></span></p>
                            <div class="input-group input-group-md mb-3">
                        ...
                        <div class="col-md-12">
                            <p class="mb-1 font-weight-bold"><label for="location"><strong>
                                {{ __('Location') }}<span class="text-danger">&nbsp;*</span>
                            </strong></label> <span class="text-danger"></span></p>
                            <div class="form-group mb-3">
                                <textarea name="location" id="location" class="form-control" rows="3" placeholder="{{ __('Location') }}" required></textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <p class="mb-1 font-weight-bold"><label for="address"><strong>{{ __('Address') }}<span class="text-danger">&nbsp;*</span></strong></label> <span class="text-danger"></span></p>
                            <div class="form-group mb-3">
