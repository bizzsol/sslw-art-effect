...
<div class="col-lg-12">
    <div class="iq-card">
        <div class="iq-card-header d-flex justify-content-between p-0 bg-white">
            <div class="iq-header-title">
                <h4 class="card-title text-primary border-left-heading"><a href="{{ url('pms/billing-audit/billing-po-attachment-list') }}">MONTHLY PO STATS&nbsp;&nbsp;|&nbsp;&nbsp;{{ date('d-M-Y', strtotime($from)) }} to {{ date('d-M-Y', strtotime($to)) }}</a></h4>
            </div>
        </div>
        <div class="iq-card-body p-0">
            <div class="container-fluid p-0">
...
<div class="col-lg-12">
    <div class="iq-card">
        <div class="iq-card-header d-flex justify-content-between p-0 bg-white">
            <div class="iq-header-title">
                <h4 class="card-title text-primary border-left-heading"><a href="{{ url('pms/billing-audit/billing-po-attachment-list') }}">MONTHLY GRN STATS&nbsp;&nbsp;|&nbsp;&nbsp;{{ date('d-M-Y', strtotime($from)) }} to {{ date('d-M-Y', strtotime($to)) }}</a></h4>
            </div>
        </div>
        <div class="iq-card-body p-0">
            <div class="container-fluid p-0">
...
<div class="col-lg-12">
    <div class="iq-card">
        <div class="iq-card-header d-flex justify-content-between p-0 bg-white">
            <div class="iq-header-title">
                <h4 class="card-title text-primary border-left-heading"><a href="{{ url('pms/billing-audit/billing-po-attachment-list') }}">MONTHLY BILL STATS&nbsp;&nbsp;|&nbsp;&nbsp;{{ date('d-M-Y', strtotime($from)) }} to {{ date('d-M-Y', strtotime($to)) }}</a></h4>
            </div>
        </div>
        <div class="iq-card-body p-0">
            <div class="container-fluid p-0">
