    ...
    <div class="col-md-12">
        <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td>Unit:</td>
                    <td>  {{isset($user->employee->unit->hr_unit_name) ? $user->employee->unit->hr_unit_name : ''}}</td>
                </tr>
                <tr>
                    <td>Location:</td>
                    <td>
                    {{ isset($user->employee->location->hr_location_name) ? $user->employee->location->hr_location_name : '' }}
                    </td>
                </tr>
                <tr>
                    <td>Department:</td>
                ...
                <tr>
                    <td>Cost Centre:</td>
                    <td>{{ $user->costCentre ? $user->costCentre->name : '' }}</td>
                </tr>
            </tbody>
