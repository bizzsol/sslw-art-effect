            ...
            <div class="page-content">
                <div class="">
                    <div class="panel panel-info">
                        <form method="post" action="{{ route('pms.update-system-information') }}"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" name="name"
                                                       value="{{$systemInformation->name}}" id="name" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label for="organization"><strong>Organization Name <span
                                                                class="text-danger">*</span></strong></label>
                                                <input type="text" class="form-control" name="organization"
                                                       value="{{$systemInformation->organization}}" id="organization"
                                                       required>
                                            </div>
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" name="email"
                                                       value="{{$systemInformation->email}}" id="email" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label for="resend_limit"><strong>Max Resend Limit <span
                                                                class="text-danger">*</span></strong></label>
                                                <input type="number" class="form-control" name="resend_limit"
                                                       value="{{$systemInformation->resend_limit}}" id="resend_limit"
                                                       required>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="5" class="form-control" name="description"
                                                              id="description"
                                                              style="resize: none">{{$systemInformation->description}}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="5" class="form-control" name="address" id="address"
                                                              style="resize: none">{{$systemInformation->address}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <select id="is_otp_enable" name="is_otp_enable" required
                                                        class="form-control">
                                                    <option
                                                            value="no" {{$systemInformation->is_otp_enable=='no'?'selected':''}}>
                                                        No
                                                    </option>
                                                    <option
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="text" class="form-control" name="recaptcha_site_key"
                                                       value="{{$systemInformation->recaptcha_site_key}}"
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="text" class="form-control" name="recaptcha_secret_key"
                                                       value="{{$systemInformation->recaptcha_secret_key}}"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text" class="form-control" name="twitter"
                                                       value="{{$systemInformation->twitter}}" id="twitter">
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label for="facebook"><strong>Facebook :</strong></label>
                                                <input type="text" class="form-control" name="facebook"
                                                       value="{{$systemInformation->facebook}}" id="facebook">
                                            </div>
                                            <div class="col-md-3 mb-3">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text" class="form-control" name="linked_in"
                                                       value="{{$systemInformation->linked_in}}" id="linked_in">
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label for="website"><strong>Website :</strong></label>
                                                <input type="text" class="form-control" name="website"
                                                       value="{{$systemInformation->website}}" id="linked_in">
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label for="phone"><strong>Phone :</strong></label>
                                                <input type="text" class="form-control" name="phone"
                                                       value="{{$systemInformation->phone}}" id="phone">
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label for="mobile"><strong>Mobile :</strong></label>
                                                <input type="text" class="form-control" name="mobile"
                                                       value="{{$systemInformation->mobile}}" id="mobile">
                                            </div>
                                            <div class="col-md-12 mb-3">
                                                <label for="general_conditions"><strong>General Conditions
                                                                                        :</strong></label>
                                                <textarea class="form-control summernote" name="general_conditions"
                                                          id="general_conditions">{{$systemInformation->general_conditions}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        ...
                                                        <br>
                                                        <img src="{{ asset($systemInformation->logo) }}"
                                                             class="img img-fluid">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="secondary_logo"><strong>Current Secondary Logo
                                                                                            :</strong></label>
                                                        <br>
                                                        <img src="{{ asset($systemInformation->secondary_logo) }}"
                                                             class="img img-fluid">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="icon"><strong>Current Icon :</strong></label>
                                                        <br>
                                                        <img src="{{ asset($systemInformation->icon) }}"
                                                             class="img img-fluid">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="icon"><strong>Pad :</strong></label>
                                                        <br>
                                                        <img src="{{ asset($systemInformation->pad) }}"
                                                             class="img img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <label for="secondary_logo_file"><strong>New Secondary Logo
                                                                                                 :</strong></label>
                                                        <input type="file" class="form-control"
                                                               name="secondary_logo_file" id="secondary_logo_file">
                                                    </div>
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="file" class="form-control" name="pad_file"
                                                               id="pad_file">
                                                    </div>
                                                </div>
                                            </div>
