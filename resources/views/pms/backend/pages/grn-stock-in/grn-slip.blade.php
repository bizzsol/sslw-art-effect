                                            ...
                                            <table class="table mb-4">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">{{number_format($item->relGoodsReceivedItemStockIn->sum('received_qty'),0)}}</td>
                                                    </tr>
                                                    @endforeach
                                                    @endif
                                                    <tr>
                                                        <td colspan="3" class="text-right"><strong>Total:</strong></td>
                                                        <td class="text-center"><strong>{{ number_format($total_received_qty, 0) }}</strong></td>
                                                    </tr>
                                                </tbody>
                                            </table>
